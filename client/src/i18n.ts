...
const resources = {
  ja: {
    translation: {
      ...
      'footer.description': 'AIスラングメーカーは、15種類のスタイルでテキストを変換できる無料ツールです。ギャラリーで他のユーザーの変換結果を見たり、自分の作品を投稿したりもできます。',
      
      // FAQ
      'faq.title': 'よくある質問',
      'faq.subtitle': 'AIスラングメーカーに関するよくある質問と回答',
      'faq.q1': 'APIキーは必要ですか？',
      'faq.a1': 'いいえ、APIキーは不要です。Manus Built-in LLM APIを使用しているため、サーバー側で自動的に処理されます。',
      'faq.q2': 'どのくらいの長さのテキストを変換できますか？',
      'faq.a2': '最大10,000文字まで変換できます。ただし、最適な結果を得るためには5,000文字以内を推奨しています。',
      'faq.q3': '変換結果をシェアできますか？',
      'faq.a3': 'はい、変換後に自動的に短縮URLが生成され、クリップボードにコピーされます。TwitterやLINEで簡単にシェアできます。',
      'faq.q4': '画像としてダウンロードできますか？',
      'faq.a4': 'はい、変換結果をPNGまたはJPEG形式の画像としてダウンロードできます。SNSでのシェアに便利です。',
      'faq.q5': 'カスタムスキンとは何ですか？',
      'faq.a5': '自分だけのオリジナルの文体を作成できる機能です。トーン、スタイル、特徴を指定して、独自のスキンを作成できます。',
      'faq.q6': 'スキン比較モードとは何ですか？',
      'faq.a6': '同じテキストを2つの異なるスキンで同時に変換できる機能です。スキンの違いを比較したい時に便利です。',
      'faq.q7': '詳細設定の「温度」とは何ですか？',
      'faq.a7': 'AIの創造性を制御するパラメータです。値が高いほどランダムで創造的な変換になり、低いほど安定した変換になります。',
      'faq.q8': '変換結果が期待と違う場合はどうすればいいですか？',
      'faq.a8': '詳細設定で温度やTop-pを調整してみてください。また、同じテキストでも何度か変換すると異なる結果が得られます。',
      'faq.q9': '履歴機能はありますか？',
      'faq.a9': 'はい、過去の変換結果は自動的に保存され、ヘッダーの「履歴」ボタンからアクセスできます。',
      'faq.q10': '多言語対応していますか？',
      'faq.a10': 'はい、日本語、英語、中国語に対応しています。ヘッダーの言語切り替えボタンから変更できます。',
      'faq.q11': '変換回数に制限はありますか？',
      'faq.a11': '現在、変換回数に制限はありません。自由にお使いいただけます。',
      'faq.q12': 'モバイルでも使えますか？',
      'faq.a12': 'はい、レスポンシブデザインに対応しているため、スマートフォンやタブレットでも快適に使用できます。',
      'faq.contactTitle': 'その他のご質問',
      'faq.contactDesc': 'FAQに記載されていない質問がある場合は、お気軽にお問い合わせください',
      'faq.responseTime': '通常、24時間以内に返信いたします',
      
       // チュートリアル
      'tutorial.step1.title': 'テキストを貼り付け',
      'tutorial.step1.description': '変換したいテキストをコピーして、テキストエリアに貼り付けます',
      'tutorial.step2.title': 'スキンを選択',
      'tutorial.step2.description': 'お好みのスキン（文体）を選択します。関西ノリ風、おじさん構文風など15種類から選べます',
      'tutorial.step3.title': '変換ボタンをクリック',
      'tutorial.step3.description': '「変換する」ボタンをクリックします。APIキーの設定は不要です',
      'tutorial.step4.title': '結果を共有',
      'tutorial.step4.description': 'AIがテキストを選択したスキンで書き直します。TwitterやLINEで共有できます',
      'tutorial.prev': '前へ',
      'tutorial.next': '次へ',
      'tutorial.start': '始める',
      'tutorial.skip': 'スキップ',
      ...
      guideStep3Desc: '15種類のスキンから、お好みの文体を選びます。各スキンの特徴は下記をご覧ください。',
  ...
  en: {
    translation: {
      ...
      'footer.description': 'AI Slang Maker is a free tool that can convert text into 15 different styles. You can also view others\' transformations in the gallery and share your own creations.',
      
      // Tutorial
      'tutorial.step1.title': 'Paste Text',
      'tutorial.step1.description': 'Copy the text you want to transform and paste it into the text area',
      'tutorial.step2.title': 'Select Style',
      'tutorial.step2.description': 'Choose your favorite style (skin). Choose from 15 styles including Kansai Dialect and Middle-aged Man Style',
      'tutorial.step3.title': 'Click Transform',
      'tutorial.step3.description': 'Click the "Transform" button. No API key setup required',
      'tutorial.step4.title': 'Share Result',
      'tutorial.step4.description': 'AI will rewrite the text in the selected style. Share it on Twitter or LINE',
      ...
      guideStep3Desc: 'Choose your favorite writing style from 15 skins. See below for the characteristics of each skin.',
      ...
      guideSkinsTitle: '15 Types of Skins',
      ...
      'faq.subtitle': 'Frequently asked questions and answers about AI Slang Maker',
      'faq.q1': 'Do I need an API key?',
      'faq.a1': 'No, you don\'t need an API key. We use Manus Built-in LLM API, so it\'s automatically processed on the server side.',
      'faq.q2': 'How long text can I transform?',
      'faq.a2': 'You can transform up to 10,000 characters. However, we recommend 5,000 characters or less for optimal results.',
      'faq.q3': 'Can I share the transformation results?',
      'faq.a3': 'Yes, a shortened URL is automatically generated after transformation and copied to the clipboard. You can easily share it on Twitter or LINE.',
      'faq.q4': 'Can I download as an image?',
      'faq.a4': 'Yes, you can download the transformation results as PNG or JPEG images. It\'s convenient for sharing on SNS.',
      'faq.q5': 'What is a custom skin?',
      'faq.a5': 'It\'s a feature that allows you to create your own original writing style. You can specify tone, style, and characteristics to create your unique skin.',
      'faq.q6': 'What is skin comparison mode?',
      'faq.a6': 'It\'s a feature that allows you to transform the same text with two different skins simultaneously. It\'s useful when you want to compare the differences between skins.',
      'faq.q7': 'What is "temperature" in advanced settings?',
      'faq.a7': 'It\'s a parameter that controls AI\'s creativity. Higher values result in more random and creative transformations, while lower values result in more stable transformations.',
      'faq.q8': 'What should I do if the transformation result is different from my expectations?',
      'faq.a8': 'Try adjusting the temperature and Top-p in advanced settings. Also, transforming the same text multiple times will give you different results.',
      'faq.q9': 'Is there a history feature?',
      'faq.a9': 'Yes, past transformation results are automatically saved and can be accessed from the "History" button in the header.',
      'faq.q10': 'Is it multilingual?',
      'faq.a10': 'Yes, it supports Japanese, English, and Chinese. You can change the language from the language switcher button in the header.',
      'faq.q11': 'Is there a limit on the number of transformations?',
      'faq.a11': 'Currently, there is no limit on the number of transformations. Feel free to use it.',
      'faq.q12': 'Can I use it on mobile?',
      'faq.a12': 'Yes, it has a responsive design, so you can use it comfortably on smartphones and tablets.',
      'faq.contactTitle': 'Other Questions',
      'faq.contactDesc': 'If you have any questions not listed in the FAQ, please feel free to contact us',
      'faq.responseTime': 'We usually respond within 24 hours',
  ...
  zh: {
    translation: {
      ...
      'footer.about': '关于本站',
      'footer.description': 'AI俗语制造器是一个可以将文本转换为15种不同风格的免费工具。您还可以在画廊中查看其他用户的转换结果并分享您自己的作品。',
      ...
      'tutorial.step1.description': '复制您想要转换的文本并粘贴到文本区域',
      'tutorial.step2.title': '选择风格',
      'tutorial.step2.description': '选择您喜欢的风格（皮肤）。从15种风格中选择，包括关西方言风和大叔邮件风',
      'tutorial.step3.title': '点击转换',
      'tutorial.step3.description': '点击“转换”按钮。无需设置API密钥',
      'tutorial.step4.title': '分享结果',
      'tutorial.step4.description': 'AI将以选定的风格重写文本。在Twitter或LINE上分享',
      'tutorial.prev': '上一步',
      'tutorial.next': '下一步',
      'tutorial.start': '开始',
      'tutorial.skip': '跳过',
      ...
      guideStep3Desc: '从15种皮肤中选择您喜欢的文体。有关每种皮肤的特征，请参阅下文。',
      ...
      // FAQ
      'faq.title': '常见问题',
      'faq.subtitle': '关于AI俗语制造器的常见问题和答案',
      'faq.q1': '需要API密钥吗？',
      'faq.a1': '不，不需要API密钥。我们使用Manus Built-in LLM API，因此在服务器端自动处理。',
      'faq.q2': '可以转换多长的文本？',
      'faq.a2': '最多可以转换10,000个字符。但是，为了获得最佳结果，我们建议5,000个字符或更少。',
      'faq.q3': '可以分享转换结果吗？',
      'faq.a3': '是的，转换后会自动生成短链接并复制到剪贴板。您可以轻松地在Twitter或LINE上分享。',
      'faq.q4': '可以下载为图片吗？',
      'faq.a4': '是的，您可以将转换结果下载为PNG或JPEG图片。它对于在SNS上分享很方便。',
      'faq.q5': '什么是自定义皮肤？',
      'faq.a5': '这是一个允许您创建自己的原创文体的功能。您可以指定语气、风格和特征来创建您的独特皮肤。',
      'faq.q6': '什么是皮肤比较模式？',
      'faq.a6': '这是一个允许您同时使用两种不同的皮肤转换相同文本的功能。当您想要比较皮肤之间的差异时，它很有用。',
      'faq.q7': '详细设置中的“温度”是什么？',
      'faq.a7': '这是一个控制AI创造力的参数。值越高，转换越随机和创造性，值越低，转换越稳定。',
      'faq.q8': '如果转换结果与期望不同，我应该怎么办？',
      'faq.a8': '请尝试在详细设置中调整温度和Top-p。此外，多次转换相同文本会给您不同的结果。',
      'faq.q9': '有历史功能吗？',
      'faq.a9': '是的，过去的转换结果会自动保存，可以从标题中的“历史”按钮访问。',
      'faq.q10': '支持多语言吗？',
      'faq.a10': '是的，它支持日语、英语和中文。您可以从标题中的语言切换按钮更改语言。',
      'faq.q11': '转换次数有限制吗？',
      'faq.a11': '目前，转换次数没有限制。请随意使用。',
      'faq.q12': '可以在移动设备上使用吗？',
      'faq.a12': '是的，它具有响应式设计，因此您可以在智能手机和平板电脑上舒适地使用它。',
      'faq.contactTitle': '其他问题',
      'faq.contactDesc': '如果您有任何FAQ中未列出的问题，请随时与我们联系',
      'faq.responseTime': '我们通常在24小时内回复',
