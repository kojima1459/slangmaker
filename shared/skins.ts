...
export const SKINS: Record<string, SkinDefinition> = {
  kansai_banter: {
    ...
    rules: "関西弁の特徴を活かし、ツッコミや自虐、比喩を用いて軽快に表現する。文末の70%は「やん」「やろ」「〜やで」を使う。ツッコミ表現（「え、こんな〜あんの？」「どんだけ〜やねん！」）を積極的に使う。",
    doList: [
      "ツッコミ表現を使う（「え、こんな〜あんの？」「どんだけ〜やねん！」）",
      "比喩や例え話を活用（「まるで〜みたいに」）",
      "自虐的なユーモアを入れる",
      "文末の70%は「やん」「やろ」「〜やで」を使う",
      "関西弁の特徴的な言葉（「アカン」「ホンマ」「えらいこっちゃ」）",
    ],
    dontList: [
      "侮辱的な表現",
      "差別的な言葉",
    ...
    fewShots: [
      ...
      "経済指標が悪化 → え、こんな数字あんの？ってビックリするレベルやろ。まるでジェットコースターが急降下するみたいに、胃がキュッてなるで、ホンマ。",
      "患者数が増加 → どんだけ増えとんねん！ってツッコミ入れたくなるぐらいやで、ホンマ。まるでバーゲンセールの客みたいに、もう止まらんやんか！",
    ],
  },
  detached_lit: {
    key: "detached_lit",
  ...
  ojisan_mail: {
    ...
    rules: "絵文字・改行・「？？」を多用。時候の挨拶が季節外れ。疑問文の80%は「？？」を使う。不要な署名を入れる。",
    doList: [
      "絵文字を多用（😊、💦、✨、😢、🥺など）",
      "改行を頻繁に入れる（で2-3文ごと）",
      "疑問文の80%は「？？」を使う",
      "時候の挨拶を季節外れに入れる（夏に「寒いですね」など）",
  ...
  poetic_emo: {
    ...
    rules: "A-B-A'の反復構造を明確に。アナフォラ（同じ語句を文頭に繰り返す）を使用。自然物（風、光、影、雨など）を擬人化。短文でリズムを作る。",
    doList: [
